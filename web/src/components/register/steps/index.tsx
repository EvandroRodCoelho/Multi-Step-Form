...
export function Steps({ currentStep }: StepsProps) {
    ...
    const getStepBackground = (step: number) => {
      return isStepActive(step) ? "bg-blue-800" : "bg-gray-300";
    };
    ...
    return (
      <div className="relative after:absolute after:inset-x-0 after:top-1/2 after:block after:h-0.5 after:-translate-y-1/2 after:rounded-lg after:bg-zinc-200">
